...
label define topcods_lab 1 "Cerebrovascular diseases (I60-I69)" 2 "Ischemic heart diseases (I20-I25)" 3 "Diabetes mellitus (E10-E14)" ///
						 ...
						 7 "Malignant neoplasm of colon, rectosigmoid junction, rectum & anus (C18-C21)" 8 "Malignant neoplasm of female breast (C50)" 99 "Other UCODs" , modify
...
replace topcods=7 if regexm(dd_cod1d, "OF THE ANAL CANAL") &  topcods==. // changes
replace topcods=7 if regexm(dd_cod1c, "OF THE ANAL CANAL") &  topcods==. & (dd_cod1d==""|dd_cod1d=="99") // changes
replace topcods=7 if regexm(dd_cod1b, "OF THE ANAL CANAL") &  topcods==. & (dd_cod1c==""|dd_cod1c=="99") & (dd_cod1d==""|dd_cod1d=="99") // changes
replace topcods=7 if regexm(dd_cod1a, "OF THE ANAL CANAL") &  topcods==. & (dd_cod1b==""|dd_cod1b=="99") & (dd_cod1c==""|dd_cod1c=="99") & (dd_cod1d==""|dd_cod1d=="99") // changes

replace topcods=7 if regexm(dd_cod1d, "ANAL") & !(strmatch(strupper(dd_cod1d),"*ANALYSIS*")) & !(strmatch(strupper(dd_cod1d),"*ANAL SPHINCTER DISORDER*")) & !(strmatch(strupper(dd_cod1d),"*INTRACRANAL*")) &  topcods==. // changes
replace topcods=7 if regexm(dd_cod1c, "ANAL") & !(strmatch(strupper(dd_cod1c),"*ANALYSIS*")) & !(strmatch(strupper(dd_cod1c),"*ANAL SPHINCTER DISORDER*")) & !(strmatch(strupper(dd_cod1c),"*INTRACRANAL*")) &  topcods==. & (dd_cod1d==""|dd_cod1d=="99") // changes
replace topcods=7 if regexm(dd_cod1b, "ANAL") & !(strmatch(strupper(dd_cod1b),"*ANALYSIS*")) & !(strmatch(strupper(dd_cod1b),"*ANAL SPHINCTER DISORDER*")) & !(strmatch(strupper(dd_cod1b),"*INTRACRANAL*")) &  topcods==. & (dd_cod1c==""|dd_cod1c=="99") & (dd_cod1d==""|dd_cod1d=="99") // changes
replace topcods=7 if regexm(dd_cod1a, "ANAL") & !(strmatch(strupper(dd_cod1a),"*ANALYSIS*")) & !(strmatch(strupper(dd_cod1a),"*ANAL SPHINCTER DISORDER*")) & !(strmatch(strupper(dd_cod1a),"*INTRACRANAL*")) &  topcods==. & (dd_cod1b==""|dd_cod1b=="99") & (dd_cod1c==""|dd_cod1c=="99") & (dd_cod1d==""|dd_cod1d=="99") // changes


replace topcods=7 if regexm(dd_cod1d, "ANUS") & !(strmatch(strupper(dd_cod1d),"*TETANUS*")) &  topcods==. // changes
replace topcods=7 if regexm(dd_cod1c, "ANUS") & !(strmatch(strupper(dd_cod1c),"*TETANUS*")) &  topcods==. & (dd_cod1d==""|dd_cod1d=="99") // changes
replace topcods=7 if regexm(dd_cod1b, "ANUS") & !(strmatch(strupper(dd_cod1b),"*TETANUS*")) &  topcods==. & (dd_cod1c==""|dd_cod1c=="99") & (dd_cod1d==""|dd_cod1d=="99") // changes
replace topcods=7 if regexm(dd_cod1a, "ANUS") & !(strmatch(strupper(dd_cod1a),"*TETANUS*")) &  topcods==. & (dd_cod1b==""|dd_cod1b=="99") & (dd_cod1c==""|dd_cod1c=="99") & (dd_cod1d==""|dd_cod1d=="99") // changes
...
replace topcods=7 if dd_record_id==33230
