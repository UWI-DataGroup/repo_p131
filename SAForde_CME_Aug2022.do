...
import excel using "`datapath'\version15\1-input\BNRDeathData20082021-LengthOfTimeBetDeath_DATA_2022-08-25_1125_excel.xlsx" , firstrow case(lower)
...
save "`datapath'\version15\2-working\regdoddiff" ,replace
restore
...
collapse year median_regdoddiff range_lower range_upper mean_regdoddiff
append using "`datapath'\version15\2-working\regdoddiff"
...
preserve
use "`datapath'\version15\2-working\regdoddiff", clear
putdocx clear
putdocx begin
